...
static constexpr size_t SIGNATURE_SIZE_BYTES = 384;
static constexpr size_t DH_KEY_SIZE_BYTES = 384;
...
public:
    ...
    // ********************** Certificates *******************************
    static bool checkCertificate(IN const BYTE* caCertBuffer, IN size_t caCertSizeBytes, IN const BYTE* certBuffer, IN size_t certSizeBytes, IN const char* expectedCN);
